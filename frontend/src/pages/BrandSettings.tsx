...
const IDENTITY_FIELDS: { key: keyof BrandSettings; label: string; type?: string }[] = [
  ...
  { key: 'primary_color', label: 'اللون الرئيسي Primary', type: 'color' },
  { key: 'secondary_color', label: 'اللون الثانوي Secondary', type: 'color' },
  { key: 'button_color', label: 'لون الأزرار', type: 'color' },
  { key: 'header_color', label: 'لون Header', type: 'color' },
  { key: 'sidebar_color', label: 'لون Sidebar', type: 'color' },
  { key: 'background_color', label: 'لون خلفية النظام', type: 'color' },
  { key: 'card_color', label: 'لون Cards', type: 'color' },
  { key: 'table_header_color', label: 'لون رأس الجدول', type: 'color' },
  { key: 'table_alt_row_color', label: 'لون صفوف الجداول المتناوبة', type: 'color' },
  { key: 'text_color', label: 'لون النصوص', type: 'color' },
  { key: 'border_color', label: 'لون Borders', type: 'color' },
  { key: 'hover_color', label: 'لون Hover', type: 'color' },
  { key: 'active_nav_color', label: 'لون التنقل النشط', type: 'color' },
  { key: 'success_color', label: 'Success', type: 'color' },
  { key: 'warning_color', label: 'Warning', type: 'color' },
  { key: 'danger_color', label: 'Danger', type: 'color' },
  { key: 'info_color', label: 'Info', type: 'color' },
];
